...
const PendingCars = ({ navigation }) => {
  ...
  const PendingCarsData = async () => {
    setLoading(true);
    setRefreshing(true);
    const config = {
      method: "get",
      maxBodyLength: Infinity,
      url: `auth/get_carpending.php?duser_id=${userData.user.duserid}`,
      headers: {},
    };
        ...
        {isConnected ? (
          <View>
            {loading ? (
              ...
              >
                <AppText>You don't have any Pending Cars.</AppText>
              </View>
            )}
          </View>
        ) : (
